...
class Llama:
    ...
    def build(
        ckpt_dir: str,
        tokenizer_path: str,  # Not used anymore
        max_seq_len: int,
        max_batch_size: int,
    ...
    def generate(
        ...
        for k, t in enumerate(prompt_tokens):
            # Clamp token indices to valid range [0, vocab_size-1]
            t_tensor = torch.tensor(t, dtype=torch.long, device="cpu").clamp(0, self.model.params.vocab_size - 1)
